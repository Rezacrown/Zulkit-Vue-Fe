      ...
      <div class="w-full px-1 my-1 md:w-1/2 lg:my-4 lg:px-4 lg:w-1/4">
        <div class="overflow-hidden border border-gray-200 rounded-xl">
          ...
          <header class="px-4 mb-4 leading-tight">
            ...
            <span class="block text-sm font-light text-gray-500 no-underline"> 731 items </span>
          </header>
        </div>
      </div>
      <div class="w-full px-1 my-1 md:w-1/2 lg:my-4 lg:px-4 lg:w-1/4">
        <div class="overflow-hidden border border-gray-200 rounded-xl">
          ...
          <header class="px-4 mb-4 leading-tight">
            ...
            <span class="block text-sm font-light text-gray-500 no-underline"> 657 items </span>
          </header>
        </div>
      </div>
      <div class="w-full px-1 my-1 md:w-1/2 lg:my-4 lg:px-4 lg:w-1/4">
        <div class="overflow-hidden border border-gray-200 rounded-xl">
          ...
          <header class="px-4 mb-4 leading-tight">
            ...
            <span class="block text-sm font-light text-gray-500 no-underline"> 83,559 items </span>
          </header>
        </div>
      </div>
      <div class="w-full px-1 my-1 md:w-1/2 lg:my-4 lg:px-4 lg:w-1/4">
        <div class="overflow-hidden border border-gray-200 rounded-xl">
          ...
          <header class="px-4 mb-4 leading-tight">
            ...
            <span class="block text-sm font-light text-gray-500 no-underline"> 4,500 items </span>
          </header>
        </div>
      </div>
    </div>
